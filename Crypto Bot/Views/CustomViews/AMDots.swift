...
public class AMDots: UIView {
  ...
  private var defaultsColors = [#colorLiteral(red: 0.2675501704, green: 0.3232595325, blue: 0.3734717369, alpha: 1),#colorLiteral(red: 0.2675501704, green: 0.3232595325, blue: 0.3734717369, alpha: 1),#colorLiteral(red: 0.2675501704, green: 0.3232595325, blue: 0.3734717369, alpha: 1),#colorLiteral(red: 0.2675501704, green: 0.3232595325, blue: 0.3734717369, alpha: 1)]
  private var defaultsBlinkingColor = #colorLiteral(red: 0.4913434386, green: 0.5670532584, blue: 0.6552561522, alpha: 1)
